...
Seven observations from the total of 22{,}718 have null type values and are
excluded from this breakdown; aggregate counts elsewhere use the full
$n = 22{,}718$. \texttt{discovery} and \texttt{pattern} together account for
69\,\% of all typed observations.}
\label{fig:types}
\end{figure}
