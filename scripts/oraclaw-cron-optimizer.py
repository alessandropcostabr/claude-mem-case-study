...
Cron: 0 4 * * 0 /usr/bin/python3 ~/clawd/scripts/oraclaw-cron-optimizer.py --apply
...
REPORT_PATH = Path.home() / 'clawd/learn/cron-optimizer-report.json'
BACKUP_DIR = Path.home() / 'clawd/learn/cron-backups'
